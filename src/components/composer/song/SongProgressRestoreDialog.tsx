    ...
    return (
        ...
        >
            <div className="mx-auto max-w-screen-lg h-full flex justify-center items-center">
                ...
                >
                    <h1 className="text-xl font-semibold tracking-tight mb-4">Your previous composition was saved!</h1>
                    <p className="tracking-tight opacity-90">
                        The progress from a previous composing session for this song combination has been found. Do you want to
                        restore the progress or discard it and start all over again?
                    </p>
                    <div className="w-full flex flex-row justify-between mt-10">
                        <DialogButton onClick={() => callback(discard)}>Discard</DialogButton>
                        <DialogButton onClick={() => callback(restore)} primary>
                            Restore
                        </DialogButton>
                    </div>
                </motion.div>
